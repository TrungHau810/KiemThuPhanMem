    ...
    public class PTBac2_53_57_HauNgoc
    {
        ...
        public string Solve_53_57_HauNgoc()
        {
            if (this.a_53_57_HauNgoc == 0)
            {
                ...
                return $"x = {(-this.c_53_57_HauNgoc / this.b_53_57_HauNgoc):G}"; // G (General Format): Nếu số là số nguyên, nó sẽ k hiển thị dấu phẩy (2 thay vì 2.00)
            }
            ...
            else if (delta_53_57_HauNgoc == 0)
            {
                ...
                return $"Nghiệm kép x = {x_53_57_HauNgoc:F2}";
            }
            else
            {
                ...
                return $"x1 = {x1_53_57_HauNgoc:F2}, x2 = {x2_53_57_HauNgoc:F2}";
            }
        }
    }
}